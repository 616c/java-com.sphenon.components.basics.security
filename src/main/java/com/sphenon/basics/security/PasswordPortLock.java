...
public class PasswordPortLock extends LockBase {
    ...
    protected PasswordPortLock (CallContext context, String resource_id, String lock_id, String security_class) {
    ...
    static public PasswordPortLock create (CallContext context, String resource_id, String lock_id, String security_class) {
        return new PasswordPortLock(context, resource_id, lock_id, security_class);
    }
